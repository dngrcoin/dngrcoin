...
pkgdatadir = $(datadir)/dngrcoin
pkgincludedir = $(includedir)/dngrcoin
pkglibdir = $(libdir)/dngrcoin
pkglibexecdir = $(libexecdir)/dngrcoin
...
CONFIG_HEADER = $(top_builddir)/src/config/dngrcoin-config.h
...
ACLOCAL = ${SHELL} /home/mar/dngr-master/Dnggrcoin-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/mar/dngr-master/Dnggrcoin-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mar/dngr-master/Dnggrcoin-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/mar/dngr-master/Dnggrcoin-master/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/mar/dngr-master/Dnggrcoin-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = dngrcoin
PACKAGE_BUGREPORT = https://github.com/dngrcoin/dngrcoin/issues
PACKAGE_NAME = DNGRcoin
PACKAGE_STRING = DNGRcoin 1.7.3
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/mar/dngr-master/Dnggrcoin-master
abs_srcdir = /home/mar/dngr-master/Dnggrcoin-master
abs_top_builddir = /home/mar/dngr-master/Dnggrcoin-master
abs_top_srcdir = /home/mar/dngr-master/Dnggrcoin-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mar/dngr-master/Dnggrcoin-master/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/dngrcoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/dngrcoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/dngrcoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = DNGRcoin-Qt.app
OSX_VOLNAME = DNGRcoin
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_dngrcoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_dngrcoin_coverage.info test_dngrcoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/DNGRcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/dngrcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/dngrcoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/dngrcoin-config.h
$(top_srcdir)/src/config/dngrcoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/dngrcoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/DNGRcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/DNGRcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/DNGRcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_dngrcoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_dngrcoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_dngrcoin_filtered.info: test_dngrcoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_dngrcoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_dngrcoin_filtered.info
...
#test_dngrcoin_coverage.info: baseline_filtered_combined.info test_dngrcoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_dngrcoin_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_dngrcoin_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_dngrcoin_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_dngrcoin.coverage/.dirstamp:  test_dngrcoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_dngrcoin.coverage/.dirstamp total.coverage/.dirstamp

# DNGRcoin: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_dngrcoin.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
