...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("DNGRcoin RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  dngrcoin-cli [options] <command> [params]  " + _("Send command to DNGRcoin") + "\n" +
                  "  dngrcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  dngrcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
