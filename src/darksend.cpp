...
{
    if(fLiteMode) return; // ignore all DNGRcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat DNGRcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("dngrcoin-privatesend");
