...
2. run dngrcoind with -printalert or -sendalert like this:
   /path/to/dngrcoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.dngrcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/DNGRcoin:0.12.0.58/"));
