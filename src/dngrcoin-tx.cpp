...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("DNGRcoin dngrcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dngrcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dngrcoin transaction") + "\n" +
              "  dngrcoin-tx [options] -create [commands]   " + _("Create hex-encoded dngrcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dngrcoin transaction
