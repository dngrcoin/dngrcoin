 ...
 *
 *   // network
 *   CDNGRcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dngrcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDNGRcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CDNGRcoinNetwork(UniValue objIn)
    {
...
// // can be under: DNGRcoinNetwork
// //   -- signature requirements : Key1(User)
// class CDNGRcoinNetworkVariable : public CGovernanceObject
// {
// private:
