...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DNGRcoinNetwork") type = DNGRcoinNetwork;
    if(strType == "DNGRcoinNetworkVariable") type = DNGRcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DNGRcoinNetwork) s = "DNGRcoinNetwork";
    if(type == DNGRcoinNetworkVariable) s = "DNGRcoinNetworkVariable";
