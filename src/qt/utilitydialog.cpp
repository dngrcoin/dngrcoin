    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DNGRcoin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About DNGRcoin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dngrcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DNGRcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DNGR, 0.1 DNGR, 1 DNGR and 10 DNGR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://dngrcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://dngrcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("DNGRcoin is shutting down...") + "<br /><br />" +
