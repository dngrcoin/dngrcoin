    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DNGR-light"), QVariant("light"));
    ui->theme->addItem(QString("DNGR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DNGR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DNGR-traditional"), QVariant("trad"));
