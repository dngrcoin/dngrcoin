    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("DNGRcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DNGRcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dngrcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About DNGRcoin"), this);
    aboutAction->setStatusTip(tr("Show information about DNGRcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DNGRcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DNGRcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DNGRcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a dngrcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DNGRcoin help message to get a list with possible DNGRcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DNGRcoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DNGRcoin network", "", count));
}
...
{
    QString strTitle = tr("DNGRcoin"); // default title
