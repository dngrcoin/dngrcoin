...
Only requiring some minor changes is dngrcoin.cpp.
...
Changes to dngrcoin.cpp
----------------------
dngrcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
