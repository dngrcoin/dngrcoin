...
DNGRcoin version 0.12.0 is now available from:

  https://dngrcoincoin.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/dngrcoincoin/dngrcoin/issues
...
backwards-compatible with pre-0.12 versions of DNGRcoin or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/dngrcoin/).
