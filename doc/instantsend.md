...
This mechanism has been integrated into Bitcore-Node-DNGRcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dngrcoincoin/insight-api-dngrcoin#web-socket-api](https://github.com/dngrcoincoin/insight-api-dngrcoin#web-socket-api) 
* API: [https://github.com/dngrcoincoin/insight-api-dngrcoin#instantsend-transactions](https://github.com/dngrcoincoin/insight-api-dngrcoin#instantsend-transactions) 
...
By default, the DNGRcoin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DNGRcoin daemon:
